...
define(/** @lends module:datatypes */
  function datatypes(require, exports, _module) {
    "use strict";
     ...
     * @class
     *
     * @property {boolean} needs_context ``true`` if this builtin type needs a
     * context, ``false`` if not.
     * @property {RegExp} regexp A JavaScript regular expression which can be
     * used to partially validate a value. This regular expression is such that
     * if it does *not* match a value, then the value is invalid. If it does
     * match the value, then {@link module:datatypes~Datatype#disallows
     * disallows} must be called to determine whether the value is actually
     * allowed or not.
     */
     ...
     * @returns {Object} The parsed value, to be used with the other methods on
     * this class. Data types are free to change the format of this object at
     * any time.
     * @param {module:datatypes~Context} context The context of the value.
     * @throws {module:datatypes/errors~ValueValidationError} If the value is
     * erroneous.
     */
     ...
     * @param {module:datatypes~Context} context The context in the document,
     * if needed.
     ...
     * @param {string} value The string from the XML document to be validated.
     * @param {Object} params The type parameters. These must be **parsed**
     * already.
     * @param {module:datatypes~Context} context The context in the document,
     * if needed.
     ...
     * @property {Array.<string, module:datatypes~Datatype>} types A map of
     * builtin type names to builtin types.
     */

    /**
     * A context as defined by the Relax NG specification, minus the base URI.
     * (Why no base URI? Because none of the types implemented by salve require
     * it. So there is no point in keeping track of it.)
     *
     * @typedef {Object} module:datatypes~Context
     * @property {module:name_resolver~NameResolver} resolver A name resolver
     * that can resolve namespace prefixes to namespace URI.
     */
     ...
     * @returns {module:datatypes~TypeLibrary} The library that corresponds to
     * the URI.
