...
define(/** @lends module:patterns */
  function patterns(require, exports, _module) {
    ...
    // have a proper namespace uri, upon ``enterStartTag`` the parsing
     ...
     * valid.
     *
     * This base class records only a minimal number of properties
     * so that child classes can avoid keeping useless properties. A prime
     * example is the walker for ``<empty>`` which is a terminal walker (it
     ...
     *
     * @returns A new object of the same class as the one being
     * cloned. The new object is a clone.
     */
