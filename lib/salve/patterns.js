 ...
 * attributes, ``false`` otherwise.
 *
 * @returns {boolean|Array.<module:patterns~ValidationError>} ``false`` if the
 ...
 *
 * @returns {false|Array.<module:patterns~ValidationError>} The value ``false``
 * if there is no error or an array of {@link module:patterns~ValidationError
