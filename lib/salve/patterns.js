...
define(/** @lends module:patterns */
  function patterns(require, exports, _module) {
    ...
    function addWalker(elCls, walkerCls) {
      elCls.prototype.newWalker = function newWalker(nameResolver) {
        /* jshint newcap: false */
        return new walkerCls(this, nameResolver);
      };
    }
     ...
     * created.
     * @param {module:name_resolver~NameResolver} nameResolver The name
     * resolver that can be used to convert namespace prefixes to namespaces.
     */
    function ListWalker(el, nameResolver) {
      Walker.call(this);
      this.el = el;
     ...
     * resolver that can be used to convert namespace prefixes to namespaces.
     */
    function ValueWalker(el, nameResolver) {
      Walker.call(this);
      this.el = el;
      this.nameResolver = nameResolver;
      this.matched = false;
     ...
     * resolver that can be used to convert namespace prefixes to namespaces.
     */
    function DataWalker(el, nameResolver) {
      Walker.call(this);
      this.el = el;
      this.nameResolver = nameResolver;
    ...
    Ref.prototype.newWalker = function newWalker(nameResolver) {
      return this.resolves_to.pat.newWalker(nameResolver);
    };
     ...
     * resolver that can be used to convert namespace prefixes to namespaces.
     */
    function OneOrMoreWalker(el, nameResolver) {
      Walker.call(this);
     ...
     * resolver that can be used to convert namespace prefixes to namespaces.
     */
    function ChoiceWalker(el, nameResolver) {
      Walker.call(this);
      this.el = el;
      this.nameResolver = nameResolver;
      this.chosen = false;
     ...
     * resolver that can be used to convert namespace prefixes to namespaces.
     */
    function GroupWalker(el, nameResolver) {
      Walker.call(this);
      this.el = el;
      this.nameResolver = nameResolver;
      this.hit_a = false;
     ...
     * resolver that can be used to convert namespace prefixes to namespaces.
     */
    function InterleaveWalker(el, nameResolver) {
      Walker.call(this);
      this.el = el;
      this.nameResolver = nameResolver;
     ...
     * resolver that can be used to convert namespace prefixes to namespaces.
     */
    function AttributeWalker(el, nameResolver) {
      Walker.call(this);
      this.el = el;
      this.nameResolver = nameResolver;
    ...
    Element.prototype.newWalker = function newWalker(nameResolver) {
      if (this.pat instanceof NotAllowed) {
        return this.pat.newWalker(nameResolver);
      }

      return new ElementWalker(this, nameResolver);
    };
     ...
     * resolver that can be used to convert namespace prefixes to namespaces.
     */
    function ElementWalker(el, nameResolver) {
      Walker.call(this);
      this.el = el;
      this.nameResolver = nameResolver;
      this.seen_name = false;
     ...
     * resolver that can be used to convert namespace prefixes to namespaces.
     */
    function DefineWalker(el, nameResolver) {
      Walker.call(this);
      this.el = el;
      this.nameResolver = nameResolver;
