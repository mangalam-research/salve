 ...
 * meant to convert the JSON data, then this method should return an Object. If
 * the <code>V2JSONWalker</code> instance is meant to check the JSON data, then
 * it should return <code>undefined</code>.
 */
