...
define(/** @lends module:conversion/parser */
  function parser(require, exports, _module) {
    "use strict";
     ...
     * SAX parsers.
     *
     * Derived classes should add methods named ``on<eventname>`` so as to form
     * a full name which matches the ``on<eventname>`` methods supported by SAX
     * parsers. The constructor will attach these methods to the SAX parser
     * passed and bind them so in them ``this`` is the ``Parser`` object. This
     * allows neatly packaged methods and private parameters.
     *
     * @class
     * @param sax_parser A parser created by the ``sax-js`` libary or something
     * compatible.
     *
     * @property sax_parser The parser passed when constructing the object.
     ...
     *
     * @class
     * @param {module:conversion/parser~Element} parent The parent element, or
     * a falsy value if this is the root element.
     ...
     * Parsers of this class use {@link module:conversion/parser~Element
     * Element} objects to represent the tree of nodes.
     *
     * @class
     ...
     * stack, the root. This root is not an element that was in the XML file
     * but a holder for the tree of elements. It has a single child which is
     * the root of the actual file parsed.
     */
