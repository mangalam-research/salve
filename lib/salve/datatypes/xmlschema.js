...
var base = {
  ...
  parseParams: function parseParams(location, params) {
    ...
    _.each(_.groupBy(params, "name"), function each(value, key) {
      ...
      if (value.length > 1) {
        ret[key] = prop.combine(_.reduceRight(_.map(value, "value"),
                                              function map(a, b) {
                                                return a.concat(b);
                                              }, []), me);
      }
...
var decimal = _.extend({}, base, {
  ...
  validParams: [totalDigitsP, fractionDigitsP, patternP, minExclusiveP,
...
var integer = _.extend({}, decimal, {
  ...
  validParams: [totalDigitsP, patternP, minExclusiveP,
                 minInclusiveP, maxExclusiveP, maxInclusiveP],
  parseParams: function parseParams(location, params) {
    var me;
    var mi;
...
var float_ = _.extend({}, base, {
  ...
  regexp: doubleRe,
  validParams: [patternP, minInclusiveP, minExclusiveP,
