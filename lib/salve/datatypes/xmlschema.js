...
var base = {
    ...
    parseParams: function (location, params) {
        ...
        if (ret.hasOwnProperty("minLength") &&
            ret.hasOwnProperty("maxLength") &&
            (ret.minLength > ret.maxLength))
            errors.push(new ParamError(
                "minLength must be less than or equal to maxLength"));

        if (ret.hasOwnProperty("length")) {
            if (ret.hasOwnProperty("minLength"))
                errors.push(new ParamError(
                    "length and minLength cannot appear together"));
            if (ret.hasOwnProperty("maxLength"))
                errors.push(new ParamError(
                    "length and maxLength cannot appear together"));
        }

        if (ret.hasOwnProperty("maxInclusive")) {
            if (ret.hasOwnProperty("maxExclusive"))
                errors.push(new ParamError(
                    "maxInclusive and maxExclusive cannot appear together"));

            // maxInclusive, minExclusive
            if (ret.hasOwnProperty("minExclusive") &&
                ret.minExclusive >= ret.maxInclusive)
                errors.push(new ParamError(
                    "minExclusive must be less than maxInclusive"));
        }

        if (ret.hasOwnProperty("minInclusive")) {
            if (ret.hasOwnProperty("minExclusive"))
                errors.push(new ParamError(
            ...
            if (ret.hasOwnProperty("maxInclusive") &&
               ret.minInclusive > ret.maxInclusive)
                errors.push(new ParamError(
                    "minInclusive must be less than or equal to maxInclusive"));

            // maxExclusive, minInclusive
            if (ret.hasOwnProperty("maxExclusive") &&
                ret.minInclusive >= ret.maxExclusive)
                errors.push(new ParamError(
        ...
        if (ret.hasOwnProperty("maxExclusive") &&
            ret.hasOwnProperty("minExclusive") &&
            ret.minExclusive > ret.maxExclusive)
            errors.push(new ParamError(
...
var integer = _.extend({}, decimal, {
    ...
    parseParams: function (location, params) {
        ...
        if (this.highest_val !== undefined) {
            ...
            else if (ret.hasOwnProperty("maxInclusive")) {
        ...
        if (this.lowest_val !== undefined) {
            ...
            else if (ret.hasOwnProperty("minInclusive")) {
