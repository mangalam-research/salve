...
/**
 * Returns an array of {@link module:namePatterns~Name Name} objects which is a
 * list of all the possible names that this pattern allows.
 *
 * @returns {Array.<module:namePatterns~Name>|null} An array of names. The value
 ...
 * @param {string} path See parent class.
 *
 * @param {Array.<module:namePatterns~Base>} pats An array of length 2 which
 ...
 *
 * @param {module:namePatterns~Base} [except] Corresponds to an ``<except>``
