...
(function () {
     ...
     * _prepareAttrs recursively calls children but does not traverse
     * ref-define boundaries to avoid infinite regress...
     *
     * @method
     * @name Pattern.prototype._prepareAttrs
     *
     */
    this._prepareAttrs = function()  {
        // nothing here
    };
     ...
     * 
     * @method
     * @name Pattern.prototype.newWalker
     *
     ...
     * 
     * @method
     * @name Pattern.prototype.clone
     *
     * @returns {Pattern} A new copy.
     */
    this.clone = function () {
        return this._clone(new HashMap(function (o) { return o.hash(); }));
    };
     ...
     *
     * @method
     * @name Pattern.prototype._copyInto
     * 
    ...
    /**
     * Helper method for _prepareAttrs(). This method will remove all
     ...
     *
     * @method
     * @name Pattern.prototype._keepAttrs
     *
    ...
    /**
     * Helper method for _prepareAttrs(). This method goes through the
     ...
     * 
     * @method
     * @name Pattern.prototype._cleanAttrs
     *
    ...
    /**
     * @method
     * @name Pattern#_elementFrequency
     * 
     * @param {memo} The memo in which to store the frequency of each
     * element encountered.
     */
...
(function () {
    ...
    this._prepareAttrs = function()  {
        this.pat_a._prepareAttrs();
        this.pat_b._prepareAttrs();
    };
...
function AttributeNameError(msg, name) {
    ValidationError.call(this, msg);
    this.name = name;
}
inherit(AttributeNameError, ValidationError);
(function () {
    this.toString = function() { return this.msg + ": " + this.name; };
}).call(ValidationError.prototype);

function AttributeValueError(msg, name) {
    ValidationError.call(this, msg);
    this.name = name;
}
inherit(AttributeValueError, ValidationError);


function ElementNameError(msg, name) {
    ValidationError.call(this, msg);
    this.name = name;
}
inherit(ElementNameError, ValidationError);
(function () {
    this.toString = function () {
        return this.msg +": " + this.name.toString();
    };
}).call(ElementNameError.prototype);
...
(function () {
    this.toString = function () {
        return "must select one of these: " + this.namea.toString() + ", " + this.nameb.toString();
    };
}).call(ChoiceError.prototype);


/**
 * This class modelizes events occuring during parsing. Upon
 * encountering the start of a start tag, a "enterStartTag" event is
 ...
 * each event created.
 * 
 * An event is made of a list of event parameters, with the first one
 * being the type of the event and the rest of the list varying
...
(function () {
     ...
     * @name Walker#clone
     * @method 
     * @return {Walker} A deep copy of the Walker.
     */
    this.clone = function () {
        return this._clone(new HashMap(function (o) { return o.hash(); }));
    };
        ...
        if (!this.ended_start_tag) {
            if (!this.seen_name && ev.params[0] == "enterStartTag" && 
                ...
                if (this.walker !== undefined) {
                    ret = this.walker.end();
                    // We did not finish the attributes!
                    if (ret !== true)
                        return ret;
                }
...
(function () {
    ...
    this._prepareAttrs = function () {
        this.start._prepareAttrs();
        for (var d in this.definitions) {
            this.definitions[d]._prepareAttrs();
        }
    };
...
function constructTree(code) {
    return constructElement(JSON.parse(code));
}
