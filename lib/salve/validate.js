 ...
 * @returns {module:validate~Walker} TBA
 */
 ...
 *
 * <p>This is a destructive operation: it modifies the object on which it
 * is called. Expected to be called on patterns that have been cloned
 * from the original tree.</p>
 *
 * @private
 *
 * @returns {undefined|Array} A report of the form <code>[el, flag]</code>. The
...
/**
 * Helper function for <code>clone()</code>
 *
 * @private
 * @param {TBA} memo TBA
 * @returns {TBA} TBA
 ...
 * @private
 * @extends module:validate~Pattern
 * @param {module:validate~Pattern} Pattern TBA
 */
 ...
 * TBA
 * @private
 * @throws {module:validate~ReferenceError} TBA
 */
...
// LocalWords:  attr enterContext leaveContext definePrefix js xsl
// LocalWords:  constructObjectV
