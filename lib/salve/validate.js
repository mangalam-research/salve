 ...
 * @constructor
 *
 * @param {Array.<EName>} namea The name of the first XML entities at stake.
 * @param {Array.<EName>} nameb The name of the second XML entities at stake.
 *
 */
 ...
 * @returns {false|undefined|Array.<ValidationError>} The value
...
(function () {
     ...
     * @param {Event} ev The event to fire.
     * @returns {false|Array.<ValidationError>} The value
     * <code>valse</code> if there is no error or an array of
