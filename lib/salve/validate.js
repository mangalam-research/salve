 ...
 * grammar.
 *
 * @returns {module:validate~Set} The set of references that cannot be
 ...
 * pattern. Otherwise, an array of ValidationError objects.
 */
 ...
 *
 * @returns {Boolean} False if the walker ended without
 * error. Otherwise, a list of ValidationError object.
 */
