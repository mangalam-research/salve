 ...
 *
 *
 * @returns {module:Array.<module:validate~EName>} The list of names used in the
 * error message.
 */
 ...
 * grammar.
 * @param {Array.<module:validate~Pattern>} definitions An array of {@link
...
// LocalWords:  EName ValidationError msg modelizes args uri API
...
// LocalWords:  DefineWalker oneOrMore ChoiceWalker subwalker
// LocalWords:  ChoiceError GroupWalker addWalker unresolvable
// LocalWords:  useNameResolver GrammarWalker formedness notAllowed
// LocalWords:  ElementNameError GrammarWalker's
