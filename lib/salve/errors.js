...
/**
 * <p>This method transforms the ValidationError object to a string but uses the
 * names in the parameter passed to it to format the string.</p>
 *
 * <p>Since salve does not work with namespace prefixes, someone using salve
 * would typically use this method so as to replace the name patterns passed in
 * error messages with qualified names.</p>
 *
