 ...
 * <code>getNames()</code>, with each name replaced by a corresponding string.
 *
 ...
 * @param {string} msg The error message.
 * @param {module:name_patterns~Base} name The name of the XML entity
 * at stake.
 */
 ...
 * @constructor
 * @extends module:patterns~ValidationError
 * @param {Array.<module:name_patterns~Base>} names_a The names of the first
 * XML entities at stake.
 * @param {Array.<module:name_patterns~Base>} names_b The names of the second
 * XML entities at stake.
 */
