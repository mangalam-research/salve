 ...
 */
define(/** @lends module:nameResolver */
  function NameResolver(require, exports, _module) {
    "use strict";
    ...
    /**
     * @classdesc A name resolver for handling namespace changes in XML. This
     * name resolver maintains mappings from namespace prefix to namespace URI.
     *
     * @constructor
     */
     ...
     * This is used so that {@link module:nameResolver~NameResolver#hash hash}
     * can return unique values.
     *
     * @private
     */
    NameResolver.__id=0;
    ...
    /**
     * <p>This method is mainly used to be able to use NameResolver objects in
     * a {@link module:hashstructs~HashSet HashSet} or a {@link
     ...
     * Makes a deep copy.
     *
     * @returns {module:nameResolver~NameResolver} A deep copy of the
     * resolver.
     */
    ...
    /**
     * <p>This method is called to indicate the start of a new context.
     * Contexts enable this class to support namespace redeclarations. In XML,
     * each start tag can potentially redefine a prefix that was already
     * defined by an ancestor. When using this class, such redefinition must
     * appear in a new context, otherwise it would merely overwrite the old
     * definition.</p>
     *
     * <p>At creation, a <code>NameResolver</code> has a default context
     * already created. There is no need to create it and it is not possible to
     * leave it.</p>
     */
     ...
     * created by {@link module:nameResolver~NameResolver.enterContext
     * enterContext}.
     */
    ...
    /**
     * Resolves a qualified name to an expanded name. A qualified name is an
     * XML name optionally prefixed by a namespace prefix. For instance, in
     * <code>&lt;html xml:lang="en"></code>, "html" is a name without a prefix,
     * and "xml:lang" is a name with the "xml" prefix. An expanded name is a
     * (URI, name) pair.
     *
    ...
    NameResolver.prototype.resolveName = function resolveName(name, attribute) {
      ...
      for (var cIx = 0, ctx;
           (uri === undefined) &&
           (ctx = this._contextStack[cIx]) !== undefined; ++cIx) {
    ...
    /**
     * <p>Unresolves an expanded name to a qualified name. An expanded name is
     * a (URI, name) pair. Note that if we execute:
     *
     * <pre>
     ...
     * </pre>
     *
     * then <code>qname === qname2</code> is not necessarily true. This would
     * happen if two prefixes map to the same URI. In such case the prefix
     * provided in the return value is arbitrarily chosen.</p>
     *
     * @param {string} uri The URI part of the expanded name. An empty string
     * is valid, and basically means "no namespace". This occurrs for
     * unprefixed attributes but could also happen if the default namespace is
     * undeclared.
