 ...
 */
define(/** @lends module:oop */ function oops(require, exports, _module) {
  "use strict";
  ...
  /**
   * Makes a class implement a mixin. This means that the prototype fields of
   * the mixin are copied into the class that implements it.
   *
