...
define(/** @lends module:set */function set(require, exports, _module) {
   ...
   * to be faster than {@link module:hashstructs~HashSet HashSet}
   ...
   * with each value. If the value happens to be an ``Array``, then
   * the function is *applied* to this array. A return value which
   * is truthy includes the value, otherwise the value is excluded.
