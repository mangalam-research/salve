 ...
 */
define(/** @lends module:set */function set(require, exports, _module) {
  "use strict";
   ...
   * through the array from start to hit. So when adding a new element to the
   * Set for instance, the add method will scan the whole array, find the
   * element is not there and then add the element at the end of the array. As
   * naive as this implementation is, it has been shown to be faster than
   * {@link module:hashstructs~HashSet HashSet} when used in the context of
   * this library.</p>
   *
   ...
   * *applied* to this array. A return value which is truthy includes the
   * value, otherwise the value is excluded.
   ...
   * However, when it returns an undefined value, this return value is not
   * added to the Set that will be returned.
   *
