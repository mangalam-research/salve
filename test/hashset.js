...
describe("HashSet", function () {
    ...
    const ah_hash = function (x) { return x.hash(); };

    describe("Object with ad-hoc hash", function () {
        const init = [new Test("dog"), new Test("cat"), new Test("hamster")];
        it("creation", function () {
            const hs = new hashstructs.HashSet(ah_hash, init);
            const t = {};
            hs.forEach(x => { t[x.name] = x.name; });
            for(let x = 0, q; q = init[x]; ++x)
        ...
        it("union", function () {
            ...
            const hs2 = new hashstructs.HashSet(ah_hash, init2);
            hs2.union(hs);
...
describe("HashMap", function () {
    ...
    describe("ad-hoc hash",function () {
        ...
        it("simple", function () {
            const map = new hashstructs.HashMap(ah_hash);
